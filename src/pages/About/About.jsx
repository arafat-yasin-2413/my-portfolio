    ...
    return (
        <Container>
            <section className="min-h-screen flex items-center justify-between">
                <div className="w-full grid grid-cols-1 xl:grid-cols-2 gap-10 items-center justify-between">
                    <div>
                        {/* Text Content */}
                        <motion.div
                            ...
                            <div className="mt-6 space-y-4 text-sm md:text-base xl:text-lg leading-relaxed text-white/80">
                                <p>
                                    ...
                                    Developer who loves building modern,
                                ...
                                <p>
                                    ...
                                    curiosity—experimenting with simple layouts,
                                    breaking things, fixing them, and eventually
                                    falling in love with JavaScript and React.
                                </p>
                                ...
                                <p>
                                    ...
                                    , turning complex ideas into clean,
                                    intuitive digital experiences.
                                </p>

                                <p>
                                    Beyond coding, I enjoy playing football,
                                    exploring new tech trends, and sketching
                                    ideas—these keep my creativity fresh and
                                    mindset balanced.
                                </p>
